    ...
    for (let i = 0; i <= menu.length; i++) {
      ...
      if (menu_name.includes(search_text)) {
        menuListS.innerHTML +=
          ...
          + "                        <img src='" + menu[i].present_img + "' class='img-fluid flex-shrink-0 rounded' data-bs-toggle='tooltip' data-bs-placement='top' title='Nhấn để xem chi tiết' />"
...
function addFood(){
  ...
  const food3 = { 
    ...
    price: 12500,
    description: "TA light and fluffy omelette filled with a blend of herbs and melted cheese, creating a savory and satisfying breakfast option.",
    ingredients: 'Eggs, Butter, Cheese, Fresh herbs, Salt, Pepper',
    preparation: 'Step 1: Beat eggs with salt and pepper. Step 2: Heat butter in a pan until melted. Step 3: Pour eggs into the pan and stir gently to create bubbles. Step 4: Add cheese and fresh herbs as the eggs begin to set. Step 5: Fold the omelette in half and cook a bit more until the cheese melts. Step 6: Serve on a plate with a side of green salad.',
  ...
  const food4 = { 
    ...
    price: 6750,
    description: "A refreshing blend of mixed berries and creamy yogurt, perfect for a healthy and delicious start to your morning.",
    ingredients: 'Berries, Yogurt, Honey, Ice cubes, Vanilla extract',
    preparation: 'Step 1: Add berries, yogurt, and honey to a blender. Step 2: Add ice cubes and a bit of vanilla extract. Step 3: Blend until smooth. Step 4: Pour into a glass and enjoy cold.',
  ...
  const food5 = { 
    ...
    price: 11500,
    description: "Crunchy granola mixed with a variety of nuts and a scoop of protein powder, served with your choice of milk or yogurt.",
    ingredients: 'Granola, Almonds, Cashews, Chia seeds, Nut milk, Protein powder',
    preparation: 'Step 1: Mix granola and nuts in a large bowl. Step 2: Add a scoop of protein powder. Step 3: Pour nut milk over the top. Step 4: Stir well and enjoy.',
  ...
  const food6 = { 
    ...
    price: 9800,
    description: "A warm tortilla filled with fresh spinach, crumbled feta cheese, and scrambled eggs, making for a nutritious and tasty breakfast wrap.",
    ingredients: 'Large tortilla, Eggs, Spinach, Feta cheese, Butter, Salt, Pepper',
    ...
    images: './img/spinach-and-feta-egg-white-wraps.jpg, ./img/spinach-feta-wrap2.jpg',
  ...
  const food7 = { 
    ...
    price: 8500,
    description: "Creamy chia pudding topped with a medley of fresh fruits and a drizzle of honey, offering a delightful and healthy treat.",
    ingredients: 'Chia seeds, Nut milk, Honey, Fresh fruits, Vanilla extract',
    preparation: 'Step 1: Mix chia seeds with nut milk and vanilla extract in a jar. Step 2: Refrigerate for at least 4 hours or overnight to allow chia seeds to expand. Step 3: Before serving, stir well and add honey. Step 4: Top with fresh fruits and enjoy.',
  ...
  const food10 = { 
    ...
    price: 15500,
    description: "A deluxe beef burger featuring a juicy beef patty, crispy bacon, melted cheese, fresh lettuce, and tomatoes, all topped with a special sauce and served in a toasted bun. A true delight for burger lovers.",
    ingredients: 'Hamburger bun, Ground beef, Cheddar cheese, Bacon, Special sauce, Lettuce, Tomato',
    preparation: 'Step 1: Form ground beef into patties and grill to desired doneness. Step 2: Grill bacon until crispy. Step 3: Toast hamburger buns in a pan with a bit of butter. Step 4: Place cheddar cheese on patties while they are still hot to melt the cheese. Step 5: Add lettuce and tomato to one side of the bun. Step 6: Place the cheese-topped patties on top and add grilled bacon. Step 7: Spread special sauce on the other side of the bun and assemble the sandwich.',
  ...
  const food11 = { 
    title: 'Veggie Wrap',
    price: 9750,
    description: "A healthy and delicious wrap filled with a mix of fresh vegetables, including lettuce, tomatoes, cucumbers, and bell peppers, all complemented by a creamy hummus spread. Ideal for a light and nutritious lunch.",
    ingredients: 'Whole wheat tortilla, Lettuce, Carrots, Onions, Hummus, Lemon juice',
    preparation: 'Step 1: Mix lettuce, shredded carrots, and thinly sliced onions in a large bowl. Step 2: Add hummus and lemon juice, and mix well. Step 3: Place the mixture in the center of the tortilla. Step 4: Fold the edges of the tortilla and tightly roll into a wrap. Step 5: Cut in half and enjoy immediately.',
  ...
  const food12 = { 
    title: 'Shrimp Tacos',
    price: 14000,
    description: "Spicy shrimp tacos featuring succulent shrimp seasoned with a blend of spices, topped with crunchy cabbage and a zesty sauce, all wrapped in soft tortillas. A flavorful and satisfying option.",
    ingredients: 'Small tortillas, Fresh shrimp, Thinly sliced cabbage, Creamy sauce, Onions, Spicy seasoning',
    preparation: 'Step 1: Season shrimp with spicy spices and grill or fry until cooked. Step 2: Prepare cabbage slaw by mixing cabbage with creamy sauce. Step 3: Heat tortillas in a pan. Step 4: Place shrimp on tortillas, add cabbage slaw, and drizzle with creamy sauce if desired. Step 5: Fold the tortillas and enjoy while hot.',
  ...
  const food13 = { 
    ...
    price: 12500,
    description: "A classic turkey club sandwich with layers of tender turkey slices, crispy bacon, fresh lettuce, tomatoes, and a creamy mayo spread, all served in toasted bread. A perfect combination of flavors and textures.",
    ingredients: 'Soft bread, Turkey breast, Bacon, Lettuce, Tomato, Mayonnaise, Butter',
    preparation: 'Step 1: Grill bacon until crispy. Step 2: Toast the soft bread until crispy and golden brown. Step 3: Spread mayonnaise on both sides of the bread. Step 4: Add lettuce and sliced tomato on one side of the bread. Step 5: Place grilled turkey breast on top and add crispy bacon. Step 6: Spread mayonnaise on the other side of the bread and assemble the sandwich. Step 7: Cut the sandwich in half and enjoy.',
    images: './img/menu-turkey-club-sandwich.jpg, ./img/turkey-club-sandwich2.jpg',
  ...
  const food14 = { 
    ...
    price: 16000,
    description: "Crispy fried fish fillets served with golden, crunchy fries and a side of tartar sauce. A classic dish that never disappoints.",
    ingredients: 'White fish, Batter, Cold water, Potatoes, Tartar sauce, Frying oil',
    preparation: 'Step 1: Prepare the batter with flour, salt, and pepper. Step 2: Dip fish into the batter and fry in hot oil until golden and crispy. Step 3: Cut potatoes into sticks and fry until crispy and golden. Step 4: Serve the fried fish with french fries and tartar sauce.',
  ...
  const food15 = { 
    ...
    price: 14500,
    description: "Slow-cooked pulled pork smothered in a rich BBQ sauce, topped with coleslaw, and served in a soft bun. A deliciously messy and satisfying sandwich.",
    ingredients: 'Soft bread, Shredded pork, BBQ sauce, Cabbage, Carrots, Pickles, BBQ seasoning',
    preparation: 'Step 1: Cook pork with BBQ sauce and seasoning until the meat is tender and easily shredded. Step 2: Shred the pork into small pieces. Step 3: Prepare coleslaw by mixing cabbage and carrots with a light dressing. Step 4: Cut the soft bread into halves and lightly toast. Step 5: Place shredded pork on one half of the bread, add coleslaw and pickles. Step 6: Place the other half of the bread on top and enjoy.',
  ...
  const food16 = { 
    title: 'Caesar Salad',
    price: 9000,
    description: "Fresh romaine lettuce tossed with Caesar dressing, crunchy croutons, and grated Parmesan cheese. A simple yet classic salad that pairs well with any meal.",
    ingredients: 'Romaine lettuce, Caesar dressing, Croutons, Parmesan cheese, Anchovy (optional)',
    preparation: 'Step 1: Wash and chop romaine lettuce. Step 2: Mix Caesar dressing with romaine lettuce in a large bowl. Step 3: Add croutons and sprinkle Parmesan cheese on top. Step 4: Toss well and serve immediately while fresh.',
  ...
  const food18 = { 
    ...
    price: 18750,
    description: "Delicate ravioli filled with tender lobster meat, served in a creamy and flavorful sauce. A luxurious treat for seafood lovers.",
    ingredients: 'Fresh ravioli, Lobster meat, Creamy tomato sauce, Parmesan cheese, Fresh herbs, Butter',
    preparation: 'Step 1: Prepare the filling by mixing lobster meat with Parmesan cheese and fresh herbs. Step 2: Stuff each ravioli with the filling. Step 3: Boil the ravioli in boiling water until they float to the surface. Step 4: Heat the creamy tomato sauce with a bit of butter. Step 5: Cook the sauce until it thickens. Step 6: Pour the sauce over the ravioli and sprinkle additional Parmesan cheese before serving.',
  ...
  const food19 = { 
    ...
    price: 20000,
    description: "Fresh salmon fillet coated with a blend of herbs and baked to a crispy finish. Accompanied by a medley of roasted vegetables.",
    ingredients: 'Salmon, Fresh herbs (basil, thyme), Flour, Butter, Roasted vegetables, Salt, Pepper',
    preparation: 'Step 1: Season salmon with salt and pepper. Step 2: Mix fresh herbs with flour. Step 3: Coat the salmon with the herb mixture. Step 4: Heat butter in a pan and cook the salmon until the herb crust is golden and crispy. Step 5: Roast vegetables (carrots, squash, bell peppers) until tender and golden. Step 6: Serve the salmon with roasted vegetables and optional cream sauce.',
    images: './img/menu-herb-crusted-salmon.jpg, ./img/herb-crusted-salmon2.jpg',
  ...
  const food20 = { 
    ...
    price: 16500,
    description: "Creamy risotto cooked with a variety of wild mushrooms and finished with a sprinkle of Parmesan cheese. A comforting and hearty dish.",
    ingredients: 'Riso Carnaroli, Wild mushrooms, Parmesan cheese, Butter, Onions, White sauce, Fresh herbs',
    preparation: 'Step 1: Heat butter in a pot, add onions, and sauté until soft. Step 2: Add riso and cook until the grains absorb the butter. Step 3: Add broth gradually, stirring constantly until the riso is tender. Step 4: Add sautéed wild mushrooms and Parmesan cheese, stirring until the mixture becomes creamy. Step 5: Season with salt and pepper to taste. Step 6: Serve hot, sprinkled with fresh herbs.',
  ...
  const food21 = { 
    ...
    price: 25000,
    description: "Tender beef tenderloin wrapped in a flaky pastry crust and baked to perfection. Served with a rich and savory sauce.",
    ingredients: 'Fresh beef, Puff pastry, Mushrooms, Onions, Butter, Madeira sauce, Eggs',
    preparation: 'Step 1: Prepare mushroom duxelles by sautéing mushrooms and onions with butter until soft and moisture is reduced. Step 2: Season beef with salt and pepper, then quickly sear in a pan with butter to keep it moist. Step 3: Place beef on the duxelles layer, then wrap in puff pastry brushed with beaten egg to create a crispy crust. Step 4: Bake in a hot oven until the puff pastry is golden and crispy and the beef reaches desired doneness. Step 5: Slice and serve with Madeira sauce.',
...
menuDetailModal.addEventListener("show.bs.modal", function (event) {
  ...
  if (preparation) {
    ...
    preparation.split(". Step").forEach(function (step, index) {
      ...
      if (step) {
        preparationList.innerHTML += `<li>Step ${
          index + 1
        }: ${step}.</li>`;
      }
    });
